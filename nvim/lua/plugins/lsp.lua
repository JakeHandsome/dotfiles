return {
   ...
   dependencies = {
      { 'mason-org/mason.nvim', opts = {}, enabled = not vim.g.NixOs },
      { 'mason-org/mason-lspconfig.nvim', enabled = not vim.g.NixOs },
         ...
         callback = function(event)
            ...
            then
               map('<leader>uh', function()
                  ...
                  vim.notify(
                     'Inlay hints ' .. tostring(enabled),
                     vim.log.levels.INFO,
                     { title = 'LSP inlay hint toggle' }
                  )
