...
doskey vim=nvim $*
:: core utils
where coreutils || echo "Installing core utils" && cargo binstall -y coreutils
...
where eza || echo "Installing eza" && cargo binstall -y eza
doskey ls=eza $*

where fnm || echo "Installing fnm" && cargo binstall -y fnm
